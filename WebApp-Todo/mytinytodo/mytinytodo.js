...
var mytinytodo = window.mytinytodo = _mtt = {
	...
	init: function(options)
	{
		...
		// handlers
		$('.mtt-tabs-add-button').click(function(event){
			addList();
		});
		...
		$('#newtask_submit').click(function(){
			submitNewTask(document.getElementById("newtask_form"));

			//$('#newtask_form').submit();
		});

		$('#newtask_adv').click(function(event){
			showEditForm(1);
			//return false;
		});
		...
		$('#search').keyup(function(event){
			...
			searchTimer = setTimeout(function(){console.log("invoi");searchTasks()}, 400);
