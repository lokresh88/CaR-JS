...
<script type="text/javascript" src="<?php mttinfo('mtt_url'); ?>carjs/jquery.xpath.js"></script>

<script type="text/javascript" src="<?php mttinfo('mtt_url'); ?>carjs/jstorage.js"></script>
<script type="text/javascript" src="<?php mttinfo('mtt_url'); ?>carjs/capture.js"></script>
...
<div id="htab_newtask">
 ...
 <td><div id="newtask_adv" class="mtt-img-button" title="<?php _e('advanced_add');?>"><span></span></div></td>
 </tr></table>
</div>
